...
export function TypewriterEffectSmoothDemo() {
  const handleDiscoverProjectsClick = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 py-2 lg:py-4">
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-8">
        <button
          onClick={handleDiscoverProjectsClick}
          className="w-full p-2 md:w-auto h-10 md:h-12 rounded-xl bg-black border border-transparent text-white text-sm md:text-base"
        >
          Discover my projects
        </button>
        <button
          onClick={handleGetInTouchClick}
          className="w-full p-2 md:w-auto h-10 md:h-12 rounded-xl bg-white border border-black text-black text-sm md:text-base"
        >
          Get in touch
        </button>
      </div>
