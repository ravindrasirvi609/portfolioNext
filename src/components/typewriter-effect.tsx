...
export function TypewriterEffectSmoothDemo() {
  ...
  <div className="flex flex-col md:flex-row gap-4 mt-8">
    <button className="w-full md:w-auto h-10 md:h-12 rounded-xl bg-black border border-transparent text-white text-sm md:text-base">
      Discover my projects
    </button>
    <button className="w-full md:w-auto h-10 md:h-12 rounded-xl bg-white border border-black text-black text-sm md:text-base">
      Get in touch
    </button>
  </div>
</div>
