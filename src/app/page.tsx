...
export default function Home() {
  ...
  const projects = [
    {
      title: "Operant Next Project",
      description: "Pharma students and conference management system.",
    },
    {
      title: "Project 2",
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-8 md:p-24 bg-gradient-to-br from-sky-100 via-gray-200 to-sky-300">
